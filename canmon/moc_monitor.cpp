...
static const char qt_meta_stringdata_Monitor[] = {
    "Monitor\0\0msg\0messageInBuffer(canMessage*)\0"
    "start()\0stop()\0"
};
...
void Monitor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->messageInBuffer((*reinterpret_cast< canMessage*(*)>(_a[1]))); break;
...
// SIGNAL 0
void Monitor::messageInBuffer(canMessage * _t1)
{
